...
(() => {
  ...
  // jsontemplate/js/jsontemplate.js
  var require_jsontemplate = __commonJS({
    "jsontemplate/js/jsontemplate.js"(exports) {
      "use strict";
      fetch("widgets/jsontemplate/i18n/translations.json").then((res) => __async(exports, null, function* () {
  ...
  // jsontemplate/js/ejs.js
  var require_ejs = __commonJS({
    "jsontemplate/js/ejs.js"(exports, module) {
      "use strict";
      (function(f) {
