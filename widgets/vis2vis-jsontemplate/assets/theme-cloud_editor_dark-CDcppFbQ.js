import{a as t}from"./_commonjsHelpers-DsqdWQfm.js";function i(a,n){for(var c=0;c<n.length;c++){const e=n[c];if(typeof e!="string"&&!Array.isArray(e)){for(const o in e)if(o!=="default"&&!(o in a)){const r=Object.getOwnPropertyDescriptor(e,o);r&&Object.defineProperty(a,o,r.get?r:{enumerable:!0,get:()=>e[o]})}}}return Object.freeze(Object.defineProperty(a,Symbol.toStringTag,{value:"Module"}))}var d={exports:{}};(function(a,n){ace.define("ace/theme/cloud_editor_dark-css",["require","exports","module"],function(c,e,o){o.exports=`
...
`}),ace.define("ace/theme/cloud_editor_dark",["require","exports","module","ace/theme/cloud_editor_dark-css","ace/lib/dom"],function(c,e,o){e.isDark=!0,e.cssClass="ace-cloud_editor_dark",e.cssText=c("./cloud_editor_dark-css");var r=c("../lib/dom");r.importCssString(e.cssText,e.cssClass,!1)}),function(){ace.require(["ace/theme/cloud_editor_dark"],function(c){a&&(a.exports=c)})}()})(d);var _=d.exports;const l=t(_),k=i({__proto__:null,default:l},[_]);export{k as t};
